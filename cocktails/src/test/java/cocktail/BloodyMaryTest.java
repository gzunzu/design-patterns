...
class BloodyMaryTest {

    private BloodyMary cocktail;

    @BeforeEach
    void init() {
        this.cocktail = new BloodyMary();
    }
    ...
    void getName() {
        ...
        assertThat(result).isEqualTo("bloody mary");
    }
    ...
    void getVessel() {
        ...
        assertThat(result).isEqualTo(Vessel.PINT_GLASS);
    }
    ...
    void getInfo() {
        ...
        assertThat(result)
                .contains("A tasteful mix of strong flavours which will arise your energy to the maximum level.")
                .contains(String.format("You'll have to wait around %.1f minutes while we make it for you.", 5f));
    ...
    void prepareWithSpecialRequest(String specialRequest) {
        ...
        assertThat(result)
                ...
                .contains(this.cocktail.tellJoke());
    ...
    void getCost() {
        ...
        assertThat(result).isGreaterThanOrEqualTo(2f);
    }
